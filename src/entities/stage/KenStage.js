...
export class KenStage {
    ...
    updateBoat(time) {
        if (time.previous > this.boat.animationTimer + (this.boat.animationDelay) * FRAME_TIME) {
            ...
            if (this.boat.animationFrame >= this.boat.animationBob.length) {
    ...
    drawBoat(context, camera) {
        this.boat.position = {
            ...
            y: Math.floor(-camera.position.y + this.boat.animationBob[this.boat.animationFrame]),
        };
