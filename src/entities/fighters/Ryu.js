...
export class Ryu extends Fighter {
    constructor(playerId, onAttackHit) {
        ...
        this.frames = new Map([
            // Instacia de parado
            ['idle-1', [[[75, 14, 60, 89], [34, 86]], PushBox.IDLE, HurtBoxRyu.IDLE]],
            ['idle-2', [[[7, 14, 59, 90], [33, 87]], PushBox.IDLE, HurtBoxRyu.IDLE]],
            ['idle-3', [[[277, 11, 58, 92], [32, 89]], PushBox.IDLE, HurtBoxRyu.IDLE]],
            ['idle-4', [[[211, 10, 55, 93], [31, 90]], PushBox.IDLE, HurtBoxRyu.IDLE]],

            // Mover para frente
            ['forwards-1', [[[4, 134, 64, 90], [27, 81]], PushBox.IDLE, HurtBoxRyu.FORWARD]],
            ['forwards-2', [[[72, 127, 73, 96], [35, 86]], PushBox.IDLE, HurtBoxRyu.FORWARD]],
            ['forwards-3', [[[152, 128, 64, 92], [35, 89]], PushBox.IDLE, HurtBoxRyu.FORWARD]],
            ['forwards-4', [[[229, 130, 63, 90], [29, 89]], PushBox.IDLE, HurtBoxRyu.FORWARD]],
            ['forwards-5', [[[307, 128, 54, 91], [25, 89]], PushBox.IDLE, HurtBoxRyu.FORWARD]],
            ['forwards-6', [[[371, 128, 50, 89], [25, 86]], PushBox.IDLE, HurtBoxRyu.FORWARD]],

            // Mover para trás
            ['backwards-1', [[[777, 128, 61, 87], [35, 85]], PushBox.IDLE, HurtBoxRyu.BACKWARD]],
            ['backwards-2', [[[430, 124, 59, 90], [36, 87]], PushBox.IDLE, HurtBoxRyu.BACKWARD]],
            ['backwards-3', [[[495, 124, 57, 90], [36, 88]], PushBox.IDLE, HurtBoxRyu.BACKWARD]],
            ['backwards-4', [[[559, 124, 58, 90], [38, 89]], PushBox.IDLE, HurtBoxRyu.BACKWARD]],
            ['backwards-5', [[[631, 125, 58, 91], [36, 88]], PushBox.IDLE, HurtBoxRyu.BACKWARD]],
            ['backwards-6', [[[707, 126, 57, 89], [36, 87]], PushBox.IDLE, HurtBoxRyu.BACKWARD]],

            // Pular para frente/tras
            ['jump-roll-1', [[[442, 261, 61, 78], [22, 90]], PushBox.JUMP, [[17, -90, 24, 16], [-15, -90, 40, 42], [-18, -60, 40, 32]]]],
            ['jump-roll-2', [[[507, 259, 104, 42], [61, 76]], PushBox.JUMP, [[17, -90, 24, 16], [-14, -91, 40, 42], [-22, -66, 38, 18]]]],
            ['jump-roll-3', [[[617, 240, 53, 82], [42, 111]], PushBox.JUMP, [[22, -51, 24, 16], [-14, -81, 40, 42], [-22, -66, 38, 18]]]],
            ['jump-roll-4', [[[676, 257, 122, 44], [71, 81]], PushBox.JUMP, [[-39, -46, 24, 16], [-30, -88, 40, 42], [-34, -118, 44, 48]]]],
            ['jump-roll-5', [[[804, 258, 71, 87], [53, 98]], PushBox.JUMP, [[-72, -56, 24, 16], [-54, -77, 52, 40], [-14, -82, 48, 34]]]],
            ['jump-roll-6', [[[883, 261, 54, 109], [31, 113]], PushBox.JUMP, [[-23, -100, 24, 16], [-28, -87, 44, 38], [-22, -47, 38, 18]]]],

            // Pular
            ['jump-up-1', [[[67, 244, 56, 104], [32, 107]], PushBox.JUMP, HurtBoxRyu.JUMP]],
            ['jump-up-2', [[[138, 233, 50, 89], [25, 103]], PushBox.JUMP, HurtBoxRyu.JUMP]],
            ['jump-up-3', [[[197, 233, 54, 77], [25, 103]], PushBox.JUMP, HurtBoxRyu.JUMP]],
            ['jump-up-4', [[[259, 240, 48, 70], [28, 101]], PushBox.JUMP, HurtBoxRyu.JUMP]],
            ['jump-up-5', [[[319, 234, 48, 89], [25, 106]], PushBox.JUMP, HurtBoxRyu.JUMP]],
            ['jump-up-6', [[[375, 244, 55, 109], [31, 113]], PushBox.JUMP, HurtBoxRyu.JUMP]],

            // Pulo primeiro/ultimo frame
            ['jump-land', [[[7, 268, 55, 85], [29, 83]], PushBox.IDLE, HurtBoxRyu.IDLE]],

            // Agachar
            ['crouch-1', [[[551, 21, 53, 83], [27, 81]], PushBox.IDLE, HurtBoxRyu.IDLE]],
            ['crouch-2', [[[611, 36, 57, 69], [25, 66]], PushBox.BEND, HurtBoxRyu.BEND]],
            ['crouch-3', [[[679, 44, 61, 61], [25, 58]], PushBox.CRUNCH, HurtBoxRyu.CROUCH]],
            ...
            // Virar agachado
            ['crouch-turn-1', [[[751, 46, 53, 61], [26, 58]], PushBox.CRUNCH, [[-7, -60, 24, 18], [-28, -46, 44, 24], [-28, -24, 44, 24]]]],
            ['crouch-turn-2', [[[816, 46, 52, 61], [27, 58]], PushBox.CRUNCH, [[-7, -60, 24, 18], [-28, -46, 44, 24], [-28, -24, 44, 24]]]],
            ['crouch-turn-3', [[[878, 46, 53, 61], [29, 58]], PushBox.CRUNCH, [[-7, -60, 24, 18], [-28, -46, 44, 24], [-28, -24, 44, 24]]]],
            ...
            ['med-punch-2', [[[86, 465, 74, 95], [29, 92]], PushBox.IDLE, HurtBoxRyu.PUNCH]],
            ['med-punch-3', [[[175, 465, 108, 94], [24, 92]], PushBox.IDLE, HurtBoxRyu.PUNCH, [33, -78, 50, 18]]],

            // Soco forte
            ['heavy-punch-1', [[[175, 465, 108, 94], [24, 92]], PushBox.IDLE, HurtBoxRyu.PUNCH, [34, -78, 50, 14]]],
            ...
            // Chute medio
            ['med-kick-1', [[[162, 922, 114, 94], [68, 95]], PushBox.IDLE, [[-65, -96, 30, 18], [-57, -79, 42, 38], [-32, -52, 44, 50]], [-17, -98, 66, 28]]],

            // Chute forte
            ['heavy-kick-1', [[[5, 1196, 61, 90], [37, 87]], PushBox.IDLE, [[-41, -78, 20, 20], [-25, -78, 42, 42], [-11, -50, 42, 50]]]],
            ['heavy-kick-2', [[[72, 1192, 94, 94], [44, 91]], PushBox.IDLE, [[17, -90, 34, 34], [-25, -78, 42, 42], [-11, -50, 42, 50]], [18, -92, 60, 32]]],
